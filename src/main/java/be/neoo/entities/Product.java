...
public class Product implements Serializable {
    ...
    @ManyToOne
    @JoinColumn( name = "brand", referencedColumnName = "id", nullable = false, insertable = false, updatable = false )
    private Brand                  brand;
    ...
    @Override public boolean equals( Object o ) {
        ...
        return id == product.id && totalQuantity == product.totalQuantity && unitCostPrice == product.unitCostPrice
                ...
                product.brand ) && Objects.equals( wareHouseProducts, product.wareHouseProducts );
    }

    @Override public int hashCode() {
        return Objects.hash( id, name, totalQuantity, unitCostPrice, active, minimumQuantity, quantityBox,
                quantityPackage,
                code, category, brand, wareHouseProducts );
    }
}
